...
-- function to get budget status for all categories in a ledger
-- returns a table with category_uuid, category_name, budgeted, activity, and balance
...
begin
    ...
    select 
        ...
        coalesce(sum(a.amount), 0) as activity,
